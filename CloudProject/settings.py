...
SECRET_KEY = 'django-insecure-n@w9c(3(z(pqf4)+yllvh59+u(+7yvl3$s2mz9o71%2(+j_712'
...
SOCIAL_AUTH_VK_OAUTH2_KEY = config('SECRET_ID')
SOCIAL_AUTH_VK_OAUTH2_SECRET = config('SECRET_KEY')
